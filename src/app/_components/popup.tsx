    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="w-[92%] max-w-md rounded-2xl md:max-w-lg md:rounded-lg">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="mt-4 flex max-h-[55vh] scrollbar-thin flex-col gap-3 overflow-y-auto pr-1 text-left text-sm leading-relaxed md:max-h-none md:overflow-visible md:pr-0 md:text-justify">
            <p className="indent-6 md:indent-8">
              ...
              shouldn&apos;t require a map and compass to navigate. Consider
              this a developer&apos;s love-letter to modern, interactive
              filters.
            </p>
            ...
            <p className="indent-6 md:indent-8">
              The codebase behind this project is dog water, and I probably did
              the Higuruma meme while reading every line of code. But hey, it
              gets the job done and saves us all from calculating with the
            ...
            <Alert className="mt-2 border-blue-500/30 bg-blue-50/50 p-3 text-blue-900 dark:border-blue-500/30 dark:bg-blue-950/30 dark:text-blue-200">
              ...
              <AlertTitle className="text-xs font-semibold md:text-sm">
        ...
        <AlertDialogFooter className="mt-4 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="border-input bg-background hover:bg-accent hover:text-accent-foreground inline-flex h-10 w-full items-center justify-center gap-1.5 rounded-md border px-4 py-2 text-xs font-medium shadow-sm sm:w-auto"
          >
